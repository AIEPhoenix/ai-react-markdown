...
#   EVIDENCE_RECALL_RUNS=100 scripts/soak/gate-evidence.sh   # quick smoke
#
# Runtime at the landed sizes is ~15-20 min: six arms x two corpora x two
# boundary modes, each re-parsing every probe position twice.
set -euo pipefail
