...
| `documentId`           | `string`                           | auto via `useId()`               | Stable id namespace for clobberable attributes. See the [React reference](react.md#aimarkdownpropstmetadata) for full semantics. Required for cross-chunk mode.                                   |
