...
Nine engine-side corrections in the built-in LaTeX preprocessor, the shared remark chain and the raw-HTML step. They change rendered bytes for the affected inputs and none of them has been through a soak campaign yet; the engine-impacting release gate applies before they ship.
