...
状态：方案已于 2026-09-09 确认，进入实施。旧库 v2.14.1 已发布并核验，GitHub 仓库已迁移到 `ai-markdown/ai-markdown`。完成包名、分层、公共入口收口和发布验证后，主列车直接发布 `3.0.0-beta.1`，使用 `beta` dist-tag。Vue 保持私有，文档站另行建设。
