    ...
    docs: {
      description: {
        component: [
          ...
          `live in [\`packages/react/src/components/typography/variants/default.scss\`](${REPO_URL}/blob/main/packages/react/src/components/typography/variants/default.scss).`,
        ].join('\n'),
      },
    },
  },
